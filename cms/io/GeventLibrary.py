...
class Service(object):
    ...
    def initialize_logging(self):
        ...
        Some of the logging handlers are only activated when running
        for a service (by choice or because of technical issues). We
        therefore provide this method for services to call as soon as
        possible, with their coords as parameters, to complete logger
        initialization.
