...
class SubmissionCommentHandler(BaseHandler):
    ...
    def post(self, submission_id, dataset_id=None):
        ...
        if dataset_id is None:
            self.redirect(self.make_unprefixed_absolute_href("submission", submission_id))
        else:
            self.redirect(self.make_unprefixed_absolute_href("submission", submission_id, dataset_id))
