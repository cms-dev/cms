...
class AddAdminHandler(SimpleHandler("add_admin.html", permission_all=True)):
    ...
    def post(self):
        fallback_page = self.make_unprefixed_absolute_href("admins", "add")
        ...
        if self.try_commit():
            self.redirect(self.make_unprefixed_absolute_href("admins"))
        else:
            self.redirect(fallback_page)
...
class AdminHandler(BaseHandler):
    ...
    def post(self, admin_id):
        ...
        try:
            ...
            self.application.service.add_notification(
                make_datetime(), "Invalid field(s)", repr(error))
            self.redirect(self.make_unprefixed_absolute_href("admin", admin_id))
            return
