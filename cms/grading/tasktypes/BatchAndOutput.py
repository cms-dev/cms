...
class BatchAndOutput(TaskType):
    ...
    ACCEPTED_PARAMETERS = [_COMPILATION, _USE_FILE,
                           _EVALUATION, _OUTPUT_ONLY_TESTCASES]
    ...
    def __init__(self, parameters):
        ...
        self.output_only_testcases = set(self.parameters[3].split(','))
