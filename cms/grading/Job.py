...
class JobGroup(object):
    ...
    def to_submission_evaluation(self, sr):
        ...
        # Should not invalidate becase evaluations will be added one by one now
        ...
        # Should not mark evaluation completed, because not all testcases
        # may be evaluated by this moment
