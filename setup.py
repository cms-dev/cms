...
PACKAGE_DATA = {
    ...
    "cmstestsuite": [
        ...
        os.path.join("tasks", "communication_fifoio_stubbed", "code", "*"),
        os.path.join("tasks", "communication_fifoio_stubbed", "data", "*.*"),
        os.path.join("tasks", "communication_many_fifoio_stubbed", "code", "*"),
        os.path.join("tasks", "communication_many_fifoio_stubbed", "data", "*.*"),
        os.path.join("tasks", "communication_many_stdio_stubbed", "code", "*"),
        os.path.join("tasks", "communication_many_stdio_stubbed", "data", "*.*"),
        os.path.join("tasks", "communication_stdio", "code", "*"),
        os.path.join("tasks", "communication_stdio", "data", "*.*"),
        os.path.join("tasks", "communication_stdio_stubbed", "code", "*"),
        os.path.join("tasks", "communication_stdio_stubbed", "data", "*.*"),
