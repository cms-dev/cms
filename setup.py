...
PACKAGE_DATA = {
    "cms.server": [
        os.path.join("static", "*.*"),
        os.path.join("static", "jquery", "*.*"),
        os.path.join("admin", "static", "*.*"),
        os.path.join("admin", "static", "jqplot", "*.*"),
        os.path.join("admin", "static", "jqplot", "plugins", "*.*"),
        ...
        os.path.join("contest", "static", "bootstrap", "css", "*.*"),
        os.path.join("contest", "static", "bootstrap", "img", "*.*"),
        os.path.join("contest", "static", "bootstrap", "js", "*.*"),
        os.path.join("contest", "static", "mimetypes", "*.*"),
