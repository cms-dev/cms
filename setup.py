...
PACKAGE_DATA = {
    ...
    "cmstestsuite": [
        ...
        os.path.join("tasks", "communication_fifoio", "code", "*"),
        os.path.join("tasks", "communication_fifoio", "data", "*.*"),
        os.path.join("tasks", "communication_stdio", "code", "*"),
        os.path.join("tasks", "communication_stdio", "data", "*.*"),
        os.path.join("tasks", "communication_stdio_unstubbed", "code", "*"),
        os.path.join("tasks", "communication_stdio_unstubbed", "data", "*.*"),
        os.path.join("tasks", "communication_many_fifoio", "code", "*"),
        os.path.join("tasks", "communication_many_fifoio", "data", "*.*"),
        os.path.join("tasks", "communication_many_stdio", "code", "*"),
        os.path.join("tasks", "communication_many_stdio", "data", "*.*"),
