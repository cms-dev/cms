...
.. sourcecode:: bash
    ...
    sudo apt-get install python3-setuptools python3-tornado python3-psycopg2 \
         ...
         python3-six python3-bs4 python3-coverage python3-requests python3-werkzeug \
...
.. sourcecode:: bash
    ...
    sudo pacman -S --needed python-setuptools python-tornado python-psycopg2 \
         ...
         python-six python-beautifulsoup4 python-coverage python-requests \
         python-werkzeug python-gevent python-bcrypt python-chardet \
         python-babel python-xdg python-jinja
