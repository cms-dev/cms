...
task_info = {
    "name": "interactivemany",
    "title": "Test Interactive Many Solutions Task",
    "official_language": "",
    "submission_format_choice": "other",
    "submission_format": "interactivemany.%l",
    "time_limit_{{dataset_id}}": "1.0",
    "memory_limit_{{dataset_id}}": "128",
    "task_type_{{dataset_id}}": "Interactive",
    "TaskTypeOptions_{{dataset_id}}_Interactive_compilation": "alone",
    ...
    "TaskTypeOptions_{{dataset_id}}_Interactive_controller_memory_limit": "512.0",
    "score_type_{{dataset_id}}": "Sum",
    "score_type_parameters_{{dataset_id}}": "100",
}
