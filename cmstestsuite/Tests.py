...
NON_INTERPRETED_LANGUAGES = (LANG_C, LANG_CPP, LANG_CPP14, LANG_PASCAL)
COMPILED_LANGUAGES = (
    LANG_C, LANG_CPP, LANG_CPP14, LANG_PASCAL, LANG_JAVA, LANG_PYTHON,
    LANG_HS, LANG_RUST, LANG_C_SHARP
)
